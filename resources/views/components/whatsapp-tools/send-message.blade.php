...
<div class="modal fade text-start" id="replyMessage{{ $message->id }}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('bot.reply-to-message', [$message->senderMessage->id, $message->message_id]) }}"
                method="POST">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="sender_message_name" id="sender_message_name"
                                    type="tel" aria-describedby="emailHelp"
                                    value="{{ $message->senderMessage->name }}" disabled>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="whats_app_message_id" id="whats_app_message_id"
                                    type="text" aria-describedby="emailHelp" value="{{ $message->message_id }}"
                                    disabled>
                                <div class="form-text" id="emailHelp">We'll never share your email with anyone else.
                                </div>
                            </div>
